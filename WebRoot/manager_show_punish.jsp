...
<html lang="en">
  ...
  <div id="top" class="clearfix">
  	...
  	<a href="" class="btn btn-default">展示惩罚信息</a>
  	 <ul class="top-right">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            ...
            <table id="example0" class="table display">
             ...
             <%
             	String disciplineNo_punish = "";
             	PunishmentDao punishmentDao = new PunishmentDao();
             	
               	if(request.getParameter("disciplineNo_punish")!=null){
               		disciplineNo_punish = request.getParameter("disciplineNo_punish");
               	}
               	ArrayList<Punishment> punishment_list = punishmentDao.getPunishment_infos_with_SpNo(disciplineNo_punish);
            	for(int i=0;i<punishment_list.size();i++){
             %>
                <tbody>
                    <tr>
                        <td><%=punishment_list.get(i).getPdate() %></td>
                        <td><%=punishment_list.get(i).getSno() %></td>
