...
<html lang="en">
  ...
  <div id="top" class="clearfix">
  	...
  	<a href="" class="btn btn-default">展示获奖信息</a>
  	 <ul class="top-right">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            ...
            <table id="example0" class="table display">
             ...
             <%
             	String disciplineNo_rewards = "";
             	AwardingDao awardingDao = new AwardingDao();
             	
               	if(request.getParameter("disciplineNo_rewards")!=null){
               		disciplineNo_rewards = request.getParameter("disciplineNo_rewards");
               	}
               	ArrayList<Awarding> awarding_list = awardingDao.getAwarding_infos_with_spno(disciplineNo_rewards);
