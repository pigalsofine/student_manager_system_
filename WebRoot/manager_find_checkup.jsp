...
<html lang="en">
  ...
  <div id="top" class="clearfix">
  	...
  	<a href="" class="btn btn-default">选择体检学生</a>
  	 <ul class="top-right">
        ...
        <div class="panel-body table-responsive">
            ...
            <table id="example3" class="table display">
                ...
                <tbody>
                        ...
                        <td>
                        	<div class="dropdown">
			                    ...
			                    <%
			                    	...
			                    	String url = "manager_find_checkup.jsp?faname="
                        	...
                        	<div class="dropdown">
			                    ...
			                    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
			                      <% 
			                      	...
			                      	for(int i=0;i<specialty_list.size();i++){
			                      	String url2 = "manager_show_check.jsp?disciplineNo_check="
                    ...
                    <td><a href="manager_add_check.jsp" class="btn">添加体检信息</a></td>
