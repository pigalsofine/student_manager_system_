...
<html lang="en">
  ...
  <div id="top" class="clearfix">
  	...
  	<a href="" class="btn btn-default">添加获奖信息</a>
  	 <ul class="top-right">
...
<form name="form1" class="form-horizontal" method="post" action="servlet/Add_AwardingServlet">
  <p>&nbsp;</p>
...
function insert()
{
  ...
  k.innerHTML=str1;
  k=n.insertCell();
  var str2 = "<div align='center'>奖项名称：<input name='two"+i.toString()+"'type='text' size='20'></div>"
  k.innerHTML=str2;
  k=n.insertCell();
  var str3 = "<div align='center'>获奖时间：<input name='three"+i.toString()+"'type='text' size='20'></div>"
  k.innerHTML=str3;
  k=n.insertCell();
