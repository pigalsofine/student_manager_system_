...
<html lang="en">
  ...
  <div id="top" class="clearfix">
  	...
  	<a href="" class="btn btn-default">更改学生成绩</a>
  	 <ul class="top-right">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            ...
            <table id="example3" class="table display">
                ...
                <tbody>
                    <tr>
        				<td>请输入学生学号-课程号-更改成绩</td>
        				
                    <tr>
                    <tr>
                    	<td>
                    		<form action="servlet/Change_ScoreServlet" method = "post" >
			                  <div class="controls">
			                    <input type="text" class="form-control" name="sno" placeholder="学号"><br>
			                    <input type="text" class="form-control" name="cno" placeholder="课程号"><br>
			                    <input type="text" class="form-control" name="score" placeholder="分数"><br>
			 					<button type="submit" class="btn btn-default btn-block">更改</button>
			                  </div>
