...
<html lang="en">
  ...
  <div id="top" class="clearfix">
  	...
  	<a href="" class="btn btn-default">查找惩罚信息</a>
  	 <ul class="top-right">
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
                        ...
                        <td>
                        	<div class="dropdown">
			                    ...
			                    <%
			                    	...
			                    	String url = "manager_find_punish.jsp?faname="
                        	...
                        	<div class="dropdown">
			                    ...
			                    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
			                      <% 
			                      	...
			                      	for(int i=0;i<specialty_list.size();i++){
			                      	String url2 = "manager_show_punish.jsp?disciplineNo_punish="
            ...
            <a href="manager_add_punish.jsp" class="btn">添加惩罚信息</a>
