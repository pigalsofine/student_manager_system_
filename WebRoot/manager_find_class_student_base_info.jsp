...
<html lang="en">
  ...
  <div id="top" class="clearfix">
  	...
  	<a href="" class="btn btn-default">查找学生</a>
  	 <ul class="top-right">
                        ...
                        <td>
                        	<div class="dropdown">
			                    ...
			                    <%
			                    	...
			                    	String url = "manager_find_class_student_base_info.jsp?faname="
                        	...
                        	<div class="dropdown">
			                    ...
			                    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
			                      <% 
			                      	...
			                      	for(int i=0;i<specialty_list.size();i++){
			                      	String url2 = "manager_find_class_student_base_info.jsp?faname="
			                      		+faname+"&specialtyName="
                        	...
                        	<div class="dropdown">
			                    ...
			                    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
			                      <% 
			                      	...
			                      	String url2 = "servlet/DoStudent_base_infoServlet?clsno="
			                      		+class_list.get(i).getClsno();
			                      %>
			                      <li role="presentation"><a role="menuitem" tabindex="-1" href=<%=url2 %>>
			                      <%=class_list.get(i).getClsname() %></a></li>
													                  <% 
				                  	}
				                  	}
				                  %>
