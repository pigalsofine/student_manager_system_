...
<html lang="en">
  ...
  <div id="top" class="clearfix">
  	...
  	<a href="" class="btn btn-default">展示体检信息</a>
  	 <ul class="top-right">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            ...
            <table id="example0" class="table display">
               ...
               <%
             	String disciplineNo_check = "";
             	Check_upDao check_upDao = new Check_upDao();
             	
               	if(request.getParameter("disciplineNo_check")!=null){
               		disciplineNo_check = request.getParameter("disciplineNo_check");
               	}
               	ArrayList<Check_up> check_up_list = check_upDao.getCheck_up_info_with_spno(disciplineNo_check);
            	for(int i=0;i<check_up_list.size();i++){
             %>
                <tbody>
                    <tr>
                        <td><%=check_up_list.get(i).getSno()%></td>
                        <td><%=check_up_list.get(i).getHeight() %></td>
                        <td><%=check_up_list.get(i).getWeight() %></td>
                        <td><%=check_up_list.get(i).getTvc() %></td>
             ...
             <tr>
                    ...
                    <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td>
                 	<%
                 		String url_disciplineNo_check = "manager_show_no_check.jsp?disciplineNo_check="
                 			+disciplineNo_check;
                 	%>
                 <td><a href=<%=url_disciplineNo_check %> class="btn">未体检名单</a></td>
