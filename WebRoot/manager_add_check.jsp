...
<html lang="en">
  ...
  <div id="top" class="clearfix">
  	...
  	<a href="" class="btn btn-default">添加体检信息</a>
  	 <ul class="top-right">
...
<form name="form1"  class="form-horizontal" method="post" action="servlet/Add_CheckServlet">
  <p>&nbsp;</p>
...
function insert()
{
  ...
  k.innerHTML=str1;
  k=n.insertCell();
  var str2 = "<div align='center'>身高(m)：<input name='two"+i.toString()+"'type='text' size='20'></div>"
  k.innerHTML=str2;
  k=n.insertCell();
  var str3 = "<div align='center'>体重(kg)：<input name='three"+i.toString()+"'type='text' size='20'></div>"
  k.innerHTML=str3;
  
  k=n.insertCell();
  var str4 = "<div align='center'>肺活量(ml)：<input name='four"+i.toString()+"'type='text' size='20'></div>"
  k.innerHTML=str4;
  k=n.insertCell();
