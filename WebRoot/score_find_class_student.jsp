...
<html lang="en">
  ...
  <div id="top" class="clearfix">
  	...
  	<a href="" class="btn btn-default">查找某班学生成绩</a>
  	 <ul class="top-right">
                        ...
                        <td>
                        	<div class="dropdown">
			                    ...
			                    <%
			                    	...
			                    	String url = "score_find_class_student.jsp?faname="
                        	...
                        	<div class="dropdown">
			                    ...
			                    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
			                      <% 
			                      	...
			                      	for(int i=0;i<specialty_list.size();i++){
			                      	String url2 = "score_find_class_student.jsp?faname="
                        	...
                        	<div class="dropdown">
			                    ...
			                    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
			                      <% 
			                      	...
			                      	String url2 = "servlet/Do_ScoreServlet?clsno="
